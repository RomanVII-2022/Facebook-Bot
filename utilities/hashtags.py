...
class Hashtag:
    ...
    def get_landing_page(self):
        try:
            ...
            self.logger.debug('*** Access to webpage was successful ***')
    ...
    def generate(self, keyword):
        try:
            ...
            self.logger.debug('*** Keyword generation was successful ***')
        except Exception as e:
            self.driver.save_screenshot('C:\\facebook\\utilities\\screenshots\\generate.png')
            self.logger.debug('*** Something went wrong generating keyword hashtags ***')
    ...
    def get_results(self):
        try:
            ...
            self.driver.close()
            self.logger.debug('*** Results were gotten successfully ***')
            return results
        except Exception as e:
            self.driver.save_screenshot('C:\\facebook\\utilities\\screenshots\\results.png')
            self.logger.debug('*** Something went wrong getting the results ***')
